...
particlesJS("js-particles", {
 ...
 $(document).ready(function () {
     ...
     (function ($) {
         $('.tab .tab__menu').find('.tab__link:eq(0)').addClass('active');
         $('.tab .tab__wrap').find('.tab__content:eq(0)').addClass('active');

         $('.tab__link').click(function (g) {
             var tab = $(this).closest('.tab'),
                 index = $(this).closest('.tab__link').index();

             tab.find('.tab__link').removeClass('active');
             tab.find('.tab__content').removeClass('active');

             $(this).closest('.tab__link').addClass('active');
            //  $(this).closest('.tab__content').addClass('active');
              tab.find('.tab__wrap').find('.tab__content:eq(' + index + ')').addClass('active');

            //  tab.find('.tab__wrap').find('.tab__content').not('.tab__content:eq(' + index + ')').slideUp();
            //  tab.find('.tab__wrap').find('.tab__content:eq(' + index + ')').slideDown();
...
//     $('.nav' + " a.nav__link").each(function () {
//         var hash = $(this).attr("href");
//         var target = $(hash);
//         if (target.position().top <= scroll && target.position().top + target.outerHeight() > scroll) {
