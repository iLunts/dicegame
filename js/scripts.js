...
$("#Path_2978").on("click", function(e) {
  e.preventDefault();
  $(".js-advisors-modal--blr").fadeIn();
  $(".advisors-modal__carousel-1").slick({
    infinite: true,
    speed: 300,
    slidesToShow: 1,
    adaptiveHeight: true
...
$("#Path_3041").hover(function() {
  $(this).toggleClass("cls-7");
});

$("#Path_3041").on("click", function(e) {
  e.preventDefault();
  $(".js-advisors-modal--ch").fadeIn();
  $(".advisors-modal__carousel-2").slick({
    infinite: true,
    speed: 300,
    slidesToShow: 1,
    adaptiveHeight: true
