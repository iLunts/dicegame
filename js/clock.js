var clock, Base, FlipClock;
$(document).ready(function() {
        var t, i = new Date("May 31, 2018 12:00:00"),
            e = new Date,
            s = i.getTime() / 1e3 - e.getTime() / 1e3;
        (t = $(".clock").FlipClock({
            clockFace: "DailyCounter",
            autoStart: !0
        })).setTime(s), t.setCountdown(!0), t.start()
    }), (Base = function() {}).extend = function(t, i) {
        "use strict";
    ...
    function(t) {
        ...
        (FlipClock = function(t, i, e) {
            return i instanceof Object && i instanceof Date == 0 && (e = i, i = 0), new FlipClock.Factory(t, i, e)
        ...
        FlipClock.Time = FlipClock.Base.extend({
            ...
            digitize: function(i) {
                ...
                if (t.each(i, function(t, i) {
                    ...
                    }), e.length > this.minimumDigits && (this.minimumDigits = e.length), this.minimumDigits > e.length)
                    for (var s = e.length; s < this.minimumDigits; s++) e.unshift("0");
                return e
            },
            ...
            getTime: function(t, i) {
                ...
                var e = t.getHours(),
                    s = [e > 12 ? e - 12 : 0 === e ? 12 : e, t.getMinutes()];
    ...
    function(t) {
        ...
        minutes: "Minuter",
        seconds: "Sekunder"
    }, FlipClock.Lang.sv = FlipClock.Lang.Swedish, FlipClock.Lang["sv-se"] = FlipClock.Lang.Swedish, FlipClock.Lang.swedish = FlipClock.Lang.Swedish, (Base = function() {}).extend = function(t, i) {
        "use strict";
        var e = Base.prototype.extend;
        Base._prototyping = !0;
        var s = new this;
